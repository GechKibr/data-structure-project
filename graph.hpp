...
public:
    ...
    void addStation(const char *name, double price)
    {
        ...
        {
            cout << "Maximum number of stations reached.\n";
            return;
        }
    ...
    void addConnection(int source, int destination, double distance)
    {
        ...
        {
            cout << "Maximum connections reached for one or both stations.\n";
            return;
        }
    ...
    void findShortestPath(int start, int end)
    {
        ...
        {
            cout << "No path exists between " << stations[start].name
                 << " and " << stations[end].name << ".\n";
            return;
        }

        cout << "Shortest path from " << stations[start].name << " to "
             << stations[end].name << " is " << distances[end] << " miles:\n";
    ...
    void updateFuelPrice(int stationId, double newPrice)
    {
        ...
        cout << "Price updated for " << stations[stationId].name << " to $" << newPrice << "\n";
    }
    ...
    void deleteConnection(int source, int destination)
    {
        ...
        if (found)
        {
            cout << "Connection between " << stations[source].name
                 << " and " << stations[destination].name << " deleted.\n";
        }
        else
        {
            cout << "No connection found between these stations.\n";
        }
    }
